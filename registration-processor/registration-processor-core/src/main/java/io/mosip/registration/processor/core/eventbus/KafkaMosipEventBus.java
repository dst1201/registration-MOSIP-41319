				...
				if(toAddress != null) {
					...
					KafkaProducerRecord<String, String> producerRecord = 
						KafkaProducerRecord.create(messageBusToAddress.getAddress(), 
							messageDTO.getRid()+ "_" + messageBusToAddress.getAddress() + ((messageDTO.getMessageBusAddress() != null && messageDTO.getMessageBusAddress().getAddress() != null) ? "_"  + messageDTO.getMessageBusAddress().getAddress() : "") , jsonObject.toString());
